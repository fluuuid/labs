...
var a = new _App2.default();

},{"./src/App":7}],2:[function(require,module,exports){
...
},{"synthetic-dom-events":4}],3:[function(require,module,exports){
(function (global){
/*!
 * VERSION: 1.19.0
 * DATE: 2016-07-14
...
var App = function () {
  function App() {
    ...
    this.bindAnimateFaces = this.animateFaces.bind(this);
    this.bindOnScroll = this.onScroll.bind(this);
    this.bindUpdateCurrentFace = this.updateCurrentFace.bind(this);
    this.bindResize = this.onResize.bind(this);

    _domEvents2.default.on(window, 'resize', this.bindResize);

    this.animateFaceProp = {
      num: 0
    };
    ...
    this.currentFace = 0;
    this.portraits = [];
    this.stageEl = document.querySelector('#container');
    this.preloadImages();
  }
  ...
  _createClass(App, [{
    ...
    value: function createScene() {
      ...
      _domEvents2.default.on(this.canvas, 'mousewheel', this.bindOnScroll);
    }
  }, {
    key: 'animateFaces',
    value: function animateFaces() {
      ...
      scaleY = window.innerHeight / maleProps.size.h;
      w = maleProps.size.w * scaleY;
      h = window.innerHeight;

      var center = (window.innerWidth - w) / 2;

      this.ctx.drawImage(this.portraits[this.currentFace], center, 0, w, h);
      this.ctx.restore();
    }
  }, {
    key: 'preloadImages',
    value: function preloadImages() {
      ...
      for (var i = maleProps.startNum; i < maleProps.total; i++) {
        var img = new Image();
        img.onload = function (e) {
          _this.portraits.push(e.target);
          _this.preloadedImages++;
          if (_this.preloadedImages >= maleProps.total - 1) {
            _this.createScene();
          }
        };
    ...
    value: function onScroll(e) {
      var aadd = Math.abs(e.wheelDelta) / 20;
      _gsap.TweenMax.killTweensOf(this);
      _gsap.TweenMax.to(this.animateFaceProp, 2.5, {
        num: this.animateFaceProp.num + aadd,
        ease: _gsap.Power4.easeOut,
        onUpdate: this.bindUpdateCurrentFace,
        onUpdateParams: [this.animateFaceProp.num]
      });
    }
  }, {
    key: 'updateCurrentFace',
    value: function updateCurrentFace(p) {
      this.currentFace = Math.max(0, Math.round(p) % maleProps.total - 1);
      this.animateFaces();
    }
  }, {
    key: 'onResize',
