...
class ScenePass {
  ...
  constructor() {
    ...
    this.rtt = new THREE.WebGLRenderTarget( window.innerWidth, window.innerHeight, { minFilter: THREE.LinearFilter, magFilter: THREE.NearestFilter } );
    this.rtt.texture.format = THREE.RGBAFormat;
